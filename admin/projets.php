                    ...
                    <table class="modern-table">
                        ...
                        <tbody>
                            ...
                            <?php foreach ($projets as $projet): ?>
                                <?php
                                $statusClass = str_replace('_', '-', $projet['statut']);
                                ...
                                <tr>
                                    ...
                                    <td><span class="status-badge status-<?= htmlspecialchars($statusClass) ?>"><?= htmlspecialchars(ucfirst(str_replace('_', ' ', $projet['statut']))) ?></span></td>
                                    <td>
