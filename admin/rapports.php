    ...
    <main class="main-content" id="mainContent">
        ...
        <nav class="top-navbar">
            <div class="navbar-left">
                ...
                <div class="navbar-breadcrumb"><i class="bi bi-file-earmark-text"></i> <span>Rapports</span></div>
            </div>
        ...
        <div class="content-area">
            <div class="page-header">
                ...
                <div class="page-actions">
                    <a href="rapport_detail.php" class="btn-modern btn-success-modern"><i class="bi bi-plus-circle"></i> Nouveau Rapport</a>
                </div>
            </div>
            <div class="filters-section mb-3">
                <form class="filters-row" method="get">
                    <div class="filter-group">
                        ...
                        <select class="filter-select" name="projet" onchange="this.form.submit()">
                            <option value="">Tous</option>
                            <option value="A">Projet A</option>
                            <option value="B">Projet B</option>
                        </select>
                    </div>
                </form>
            </div>
            <div class="table-container">
                <div class="table-wrapper">
                    <table class="modern-table">
                        <thead>
                            <tr><th>Titre</th><th>Projet</th><th>Date</th><th>Auteur</th><th>Statut</th><th>Actions</th></tr>
                        </thead>
                        <tbody>
                            <!-- Exemple de ligne -->
                            <tr>
                                <td>Rapport initial</td>
                                <td>Projet A</td>
                                <td>20/05/2026</td>
                                <td>J. Martin</td>
                                <td><span class="status-badge status-en-cours">En cours</span></td>
                                <td>
                                    <a href="rapport_detail.php?id=1" class="btn-action btn-action-view" title="Voir"><i class="bi bi-eye"></i></a>
                                    <a href="rapport_detail.php?id=1&edit=1" class="btn-action btn-action-edit" title="Modifier"><i class="bi bi-pencil"></i></a>
                                    <button type="button" class="btn-action btn-action-delete" title="Supprimer" data-bs-toggle="modal" data-bs-target="#deleteReportModal"><i class="bi bi-trash"></i></button>
                                </td>
                            </tr>
                            <!-- ...autres rapports... -->
                        </tbody>
...
<div class="modal fade modal-modern" id="deleteReportModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="mb-0">Voulez-vous vraiment supprimer ce rapport ?</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn-modern btn-outline-modern" data-bs-dismiss="modal">Annuler</button>
                <a href="rapports.php?delete=1" class="btn-modern btn-danger-modern" data-no-confirm="true">Supprimer</a>
            </div>
        </div>
    </div>
</div>
